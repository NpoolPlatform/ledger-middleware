# Npool ledger middleware

[![Test](https://github.com/NpoolPlatform/ledger-middleware/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/ledger-middleware/actions/workflows/main.yml)
...
* make ledger-middleware ```单独编译服务```
* make ledger-middleware-image ```单独生成服务镜像```
