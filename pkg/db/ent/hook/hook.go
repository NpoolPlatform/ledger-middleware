...
type CouponWithdrawFunc func(context.Context, *ent.CouponWithdrawMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CouponWithdrawFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.CouponWithdrawMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.CouponWithdrawMutation", m)
	}
	return f(ctx, mv)
}
