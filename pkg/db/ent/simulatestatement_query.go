...
func (ssq *SimulateStatementQuery) Order(o ...OrderFunc) *SimulateStatementQuery {
...
func (ssq *SimulateStatementQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (ssq *SimulateStatementQuery) GroupBy(field string, fields ...string) *SimulateStatementGroupBy {
	grbuild := &SimulateStatementGroupBy{config: ssq.config}
...
func (ssq *SimulateStatementQuery) Select(fields ...string) *SimulateStatementSelect {
	...
	selbuild := &SimulateStatementSelect{SimulateStatementQuery: ssq}
	selbuild.label = simulatestatement.Label
...
func (ssq *SimulateStatementQuery) prepareQuery(ctx context.Context) error {
	...
	if simulatestatement.Policy == nil {
		return errors.New("ent: uninitialized simulatestatement.Policy (forgotten import ent/runtime?)")
	}
	if err := simulatestatement.Policy.EvalQuery(ctx, ssq); err != nil {
		return err
	}
	return nil
}
...
func (ssq *SimulateStatementQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (ssgb *SimulateStatementGroupBy) Scan(ctx context.Context, v interface{}) error {
...
func (ssgb *SimulateStatementGroupBy) sqlScan(ctx context.Context, v interface{}) error {
...
func (ssgb *SimulateStatementGroupBy) sqlQuery() *sql.Selector {
...
func (sss *SimulateStatementSelect) Scan(ctx context.Context, v interface{}) error {
	if err := sss.prepareQuery(ctx); err != nil {
		return err
	}
	sss.sql = sss.SimulateStatementQuery.sqlQuery(ctx)
	return sss.sqlScan(ctx, v)
}

func (sss *SimulateStatementSelect) sqlScan(ctx context.Context, v interface{}) error {
	rows := &sql.Rows{}
